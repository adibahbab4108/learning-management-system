        ...
        <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
            <div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-28 py-10 border-b border-white/30">
                <div className=" flex flex-col md:items-start items-center w-full">
                    <h2 className="text-3xl text-white">EduNest</h2>
                ...
                <div className="hidden md:flex flex-col items-start w-full">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        ...
                        <button className="bg-blue-600 w-24 h-9 rounded text-white cursor-pointer">Subscribe</button>
                    </div>
                </div>
            </div>
            <p className="flex items-center justify-center py-4 md:text-sm text-white/60">Copyright 2025 <MdCopyright className="mx-1" /> EduNest. All right Reserved @ Adib </p>
        </footer>
    );
};
