    ...
    return (
        <div className={`flex items-center justify-between px-4 sm:px-10 
          ...
          ${isCourseListPage ? 'bg-white' : "bg-cyan-100/70"}`}>
            <h2 onClick={() => navigate('/')} className="text-2xl cursor-pointer">EduNest</h2>
                    ...
                    user ? <>
                        <div className="relative group inline-block text-left">
                            ...
                            <div className="absolute hidden group-hover:block right-0 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                                <ul className="py-2">
                                    <li>
                                        <Link to="/profile" className="block px-4 py-2 hover:bg-gray-100 cursor-pointer transition-all">Profile</Link>
                                    </li>
                                    <li onClick={logOut} className="px-4 py-2 hover:bg-gray-100 cursor-pointer transition-all">Log Out</li>
                                </ul>
                            </div>
                        </div>
                    </> :
